...
const APICtrl = (function () {
  ...
  return {
    ...
    postAPI_Json: (ur, data) => postAPI_Json(url, data),
...
const UICtrl = (function () {
  ...
  const UIVars = {
    ...
    // Form Elements
    displayInput: findElement('#displayField'),

    usernameInput: findElement('#usernameField'),

    emailInput: findElement('#emailField'),

    passwordInput: findElement('#passwordField'),

    passwordInput2: findElement('#passwordField2'),

    sendForm: findElement('#sendform'),


    // Small Form Elements
    dateField: findElement('#dateField'),

    displayFieldText: findElement('#displayField-text'),

    usernameFieldText: findElement('#nameField-text'),

    emailFieldText: findElement('#emailField-text'),

    passwordFieldText: findElement('#passwordField-text'),

    passwordField2Text: findElement('#passwordField2-text'),

    authCardMessage: findElement('#cd-message'),
